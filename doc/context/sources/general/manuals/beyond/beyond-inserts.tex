...
to determine reliable) it can be something place immediately, or it can become a
...
So we face two problems: there is space between the text and notes do deal with
and there (normally) is that rule before the notes which also takes some space.
