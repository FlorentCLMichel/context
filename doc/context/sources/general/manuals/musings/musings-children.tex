...
\startplacefigure[location=top]
    \startcombination[nx=4,ny=1,width=\textwidth,distance=0pt]
        {\externalfigure[private/covers/sapiens.jpg]          [height=5cm]} {history}
        {\externalfigure[private/covers/homo-deus.jpg]        [height=5cm]} {futurology}
        {\externalfigure[private/covers/children-of-time.jpg] [height=5cm]} {science fiction}
        {\externalfigure[private/covers/superintelligence.jpg][height=5cm]} {informatics}
    \stopcombination
\stopplacefigure
...
\startplacefigure[location=top]
    \startcombination[nx=4,ny=1,width=\textwidth,distance=0pt]
        {\externalfigure[private/covers/the-mind-in-the-cave.jpg]         [height=5cm]} {paleontology}
        {\externalfigure[private/covers/the-ancestors-tale.jpg]           [height=5cm]} {evolutionary biology}
        {\externalfigure[private/covers/the-good-book-of-human-nature.jpg][height=5cm]} {anthropology}
        {\externalfigure[private/covers/chaos-and-harmony.jpg]            [height=5cm]} {physics}
    \stopcombination
\stopplacefigure
...
\startplacefigure[location=top]
    \startcombination[nx=4,ny=1,width=\textwidth,distance=0pt]
        {\externalfigure[private/covers/death-by-black-hole.jpg] [height=5cm]} {astronomy}
        {\externalfigure[private/covers/the-formula.jpg]         [height=5cm]} {informatics}
        {\externalfigure[private/covers/hals-legacy.jpg]         [height=5cm]} {future science}
        {\externalfigure[private/covers/lucky-planet.jpg]        [height=5cm]} {earth science}
    \stopcombination
\stopplacefigure
...
\startplacefigure[location=top]
    \startcombination[nx=4,ny=1,width=\textwidth,distance=0pt]
        {\externalfigure[private/covers/3-16.jpg]                [height=5cm]} {art}
      % {\externalfigure[private/covers/dirt.jpg]                [height=5cm]} {history}
        {\externalfigure[private/covers/the-winds-of-change.jpg] [height=5cm]} {history}
        {\externalfigure[private/covers/pale-blue-dot.jpg]       [height=5cm]} {astronomy}
        {\externalfigure[private/covers/the-third-chimpanzee.jpg][height=5cm]} {history}
    \stopcombination
\stopplacefigure
...
\startplacefigure[location=top]
    \startcombination[nx=4,ny=1,width=\textwidth,distance=0pt]
        {\externalfigure[private/covers/from-bacteria-to-bach-and-back.jpg][height=5cm]} {philosophy}
        {\externalfigure[private/covers/the-lagoon.jpg]                    [height=5cm]} {science history}
        {\externalfigure[private/covers/chaos.jpg]                         [height=5cm]} {science}
        {\externalfigure[private/covers/why-zebras-dont-get-ulcers.jpg]    [height=5cm]} {behavioral biology}
    \stopcombination
\stopplacefigure
...
\startplacefigure[location=top]
    \startcombination[nx=4,ny=1,width=\textwidth,distance=0pt]
        {\externalfigure[private/covers/the-epigenetics-revolution.jpg]   [height=5cm]} {genetics}
        {\externalfigure[private/covers/dark-matter-and-the-dinosaurs.jpg][height=5cm]} {physics}
        {\externalfigure[private/covers/the-world-without-us.jpg]         [height=5cm]} {history}
        {\externalfigure[private/covers/what-we-cannot-know.jpg]          [height=5cm]} {science}
    \stopcombination
\stopplacefigure
...
hz. When Han The Thanh and I discussed that with Hermann Zapf he was not
surprised at all that no one saw a difference between the samples and instead was
focusing on aspects that \TEX ies are told to look at, like two hyphens in a row.
...
\startplacefigure[location=top]
    \startcombination[nx=4,ny=1,width=\textwidth,distance=0pt]
        {\externalfigure[private/covers/live-as-we-do-not-know-it.jpg][height=5cm]} {astrobiology}
        {\externalfigure[private/covers/life-on-the-edge.jpg]         [height=5cm]} {quantumbiology}
        {\externalfigure[private/covers/rare-earth.jpg]               [height=5cm]} {astrophysics}
        {\externalfigure[private/covers/austerity.jpg]                [height=5cm]} {economics}
    \stopcombination
\stopplacefigure
