...
local features = allocate {
    ...
    ["fina"] = "terminal forms",
    ["flac"] = "flattened accent forms",            -- math
    ["frac"] = "fractions",
    ["fwid"] = "full width",
    ["half"] = "half forms",
    ["haln"] = "halant forms",
    ...
    ["opbd"] = "optical bounds", -- funny, this is obsolete (too hard?) (and was recommended always true)
    ["ordn"] = "ordinals",
    ["ornm"] = "ornaments",
 ...
 -- ["ss20"] = "stylistic set 20",
    ["ssty"] = "math script-style alternates", -- math
    ...
    if k then
        ...
        if tag and dd then
            ...
            if v then
                ...
                if v then
                    return (gsub(v,"%.%.",tostring(dd))) -- new way
                end
            end
        end
    end
